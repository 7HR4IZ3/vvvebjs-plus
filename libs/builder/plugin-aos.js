...
class AosPlugin extends Plugin {
  initialize() {
    ...
    Vvveb.Builder.ignoreClasses = Vvveb.Builder.ignoreClasses.concat([
      "aos-init",
      "aos-animate",
    ]);
...
*/
    ...
    //         } else {
    //           delay(
    //             () => node.addClass("aos-init aos-animate"),
    ...
    class AOSComponent extends Component {
      type = "_base"

      get properties() {
        return [
          new PropertyGroup("Animation", { section: advanced_section }, [
            new Property("Animation Type",
              new SelectInput({ key: "type", htmlAttr: "data-aos", options: aosAnimations }),
              {
                onChange: function (node, value) {
                  node.removeClass("aos-init aos-animate");
                  if (value == "") {
            ...
            new Property("Duration",
              new RangeInput({ key: "duration", htmlAttr: "data-aos-duration", max: 10000, min: 0, step: 100 }),
              { defaultValue: "0" }
            ),
            new Property("Delay",
              new ButtonInput({ key: "delay", htmlAttr: "data-aos-delay", text: "Play Animation", icon: "la-play" }),
              {
                onChange: function (node, value) {
                  node.removeClass("aos-init aos-animate");
                  delay(
